...
import {vatAbi, cdpManagerAbi} from "./abis"
...
function Detail() {
  ...
  const positionUpdate = async () => {
    ...
    const providerUrl = "https://neoxt4seed1.ngd.network/"; // Your RPC URL
  ...
  return (
    ...
    <div>
        <div class="p-4">
          ...
          <div>
            <span class="font-medium">Unsupported chain. Please switch to Neo-X Testnet in your wallet and restart the page.</span> 
                </div>
                </div>
