  ...
  return (
    ...
    {/* {true ? 
        ...
        <div className="relative">
          ...
          <div className="pb-3">Deposited : {userPosition.transInk} GAS</div>
          <input
            type="number"
            value={depositAmount}
        ...
        {userPosition.ink === 0 ?
          ...
          >
            <span style={{ fontWeight: '700', fontSize: '15px' }}>Deposit GAS</span>
          </button>
          <button
            ...
            className="mt-5 text-sm font-medium text-blue-500 bg-white rounded-lg border border-blue-500 hover:bg-blue-500 hover:text-white focus:ring-2 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            <span style={{ fontWeight: '700', fontSize: '15px' }}>Withdraw GAS</span>
          </button>
        </div>
        }
        ...
        <div className="relative">
          ...
          <div className="pb-3">Minted : {userPosition.transArt} NSD</div>
          <input
            type="number"
            value={mintAmount}
