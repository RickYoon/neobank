    ...
    <>
        ...
        <div>   
          <OverBox>
              <SubTemplateBlockVertical>                
                <Wrappertitle>
                    <Title>Earn with NSD</Title>                
                </Wrappertitle>
                <div style={{paddingTop:"20px"}}/>
                  <div className="border border-blue-100 rounded-lg p-6 bg-white">
                  <div className="flex flex-col">
                    <div className="flex items-center">
                      <p className="text-xl font-bold text-neutral-800">NSD Saving</p>
                    </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="pt-2 grid grid-cols-[1fr_1fr] gap-3">
                        ...
                        <p className="text-neutral-600 text-right">0 NSD</p>
                      </div>
                      <div className="grid grid-cols-[1fr_1fr] gap-3">
                  ...
                  {/* <Link to="/detail/0xae78736Cd615f374D3085123A210448E74Fc6393"> */}
                    ...
                    <button style={{width:"100%", height:"50px"}} type="submit" class="mt-6 py-2.5 px-3 text-sm font-medium text-white bg-gray-500 rounded-lg hover:bg-gray-800 focus:ring-2 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
      ...
      <div>
          <OverBox>
              <SubTemplateBlockVertical>                
                  <div className="border border-blue-100 rounded-lg p-6 bg-white">
                  <p className="font-semibold">Earning with neobank</p>
                  <div className="flex flex-col">
